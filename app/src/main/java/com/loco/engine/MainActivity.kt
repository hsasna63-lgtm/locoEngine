...
fun EditorScreen(
    ...
    var worldBackgroundColor by remember(
        project.name
    ) {
    ...
    fun addComponent(
        ...
        updateObject(id) {
            ...
            val newSet =
                ComponentSet(
                    it.components.components.toMutableList()
                )
...
fun InspectorPanel(
    ...
    Column(
        ...
        if (selectedObject == null) {
            ...
            var showComponentMenu by remember(
                selectedObject.id
            ) {
